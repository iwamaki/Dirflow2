...
タスク完了時の注意：
- タスクが完了したと判断したら "suggest_reset": true を設定
- ユーザーに「他にご用はありますか？新しいタスクがあれば会話をリセットしましょう」等のメッセージを含める`,
...
5. レスポンスは必ずJSONとして有効な形式にする
6. 自然で親しみやすい口調で応答する

タスク完了時の注意：
- 分析作業が完了したと判断したら "suggest_reset": true を設定
- ユーザーに「分析は完了しました。他にご用はありますか？新しいタスクがあれば会話をリセットしましょう」等のメッセージを含める`,
